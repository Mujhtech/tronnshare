...
class WithdrawTronPageScreen extends StatefulWidget {
  const WithdrawTronPageScreen({Key key}) : super(key: key);

  @override
  _WithdrawTronPageScreenState createState() => _WithdrawTronPageScreenState();
}

class _WithdrawTronPageScreenState extends State<WithdrawTronPageScreen> {
                            ...
                            children: <Widget>[
                              Column(
                                children: <Widget>[
                                  Text(
                                    'Rate: 1TRX = ' +
                                        'USD${currentSetting.generalSettingModel.usdrate}',
                                    style: TextStyle(fontSize: 18),
                                  ),
                                  Text(
                                    'Limit: ' +
                                        '${currentSetting.generalSettingModel.tronmin} -' +
                                        ' ${currentSetting.generalSettingModel.tronmax}',
                                    style: TextStyle(fontSize: 18),
                                  ),
                                  TextFormField(
                                  ...
                                  TextFormField(
                                    controller: currentWithdraw.tronwallet,
                                    validator: (tronwallet) {
                                      if (tronwallet.isEmpty)
                                        return 'Tron Address Field is required';
                                      else
                                        return null;
                                    },
                                    decoration: const InputDecoration(
